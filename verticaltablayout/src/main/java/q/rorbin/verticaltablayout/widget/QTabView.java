...
public class QTabView extends TabView {
    ...
    public  TabIcon.Builder builder_tab;
    public  TabTitle.Builder builder_title;
    public  TabBadge.Builder builder_bad;
    ...
    public QTabView(Context context) {
        ...
        builder_tab = new TabIcon.Builder();
        mTabIcon = builder_tab.build();

        builder_title = new TabTitle.Builder();
        mTabTitle = builder_title.build();

        builder_bad = new TabBadge.Builder();
