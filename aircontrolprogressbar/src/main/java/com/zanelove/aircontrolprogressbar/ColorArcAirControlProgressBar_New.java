 ...
 */
public class ColorArcAirControlProgressBar_New extends View {
    ...
    public ColorArcAirControlProgressBar_New(Context context) {
        super(context, null);
        initView();
    }

    public ColorArcAirControlProgressBar_New(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        initCofig(context, attrs);
        initView();
    }

    public ColorArcAirControlProgressBar_New(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        setCurrentValues(curValues, value);
    ...
    private void initView() {
        ...
        hintPaint.setTextSize(curSpeedSize);
...
//        canvas.drawArc(bgRect, startAngle, currentAngle, false, progressPaint);//当前进度不用画
        ...
        if (isNeedContent) {
            ...
            if (value == 0) {
                ...
                canvas.drawText(String.format("%.0f", value) + "°C", centerX, centerY, vTextPaint);
            }
        ...
        if (isNeedUnit) {
            if (titleString.equals("")) {
                canvas.drawText(hintString, centerX, centerY + diameter / 4, hintPaint);
            } else  {
        ...
        if (isNeedTitle) {
            if (hintString.equals("")) {
                canvas.drawText(titleString, centerX, centerY + diameter / 4, curSpeedPaint);
            } else {
     ...
     * @param value
     */
    public void setCurrentValues(float currentValues, float value) {
