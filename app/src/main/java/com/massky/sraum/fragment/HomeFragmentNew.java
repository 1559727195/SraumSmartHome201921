...
import static com.massky.sraum.Utils.ParceUtil.object2String;
...
public class HomeFragmentNew extends BaseFragment1 implements AdapterView.OnItemClickListener, BridgeService.IpcamClientInterface, BridgeService.CallBackMessageInterface,VerticalTabLayout.OnTabClickListener {
...
//    ListView home_listview;
    ...
    VerticalTabLayout  tablayout_vertical;
    ...
    private class MyPagerAdapter extends PagerAdapter implements TabAdapter {
        ...
        public TabView.TabTitle getTitle(int position) {
            ...
            return new TabView.TabTitle.Builder()
                    .setContent(roomList.get(position).get("name").toString())
                    .setTextSize(12)
                  // .setTextColor(R.color.green, R.color.black)
                    .build();
        }
...
//        String areaNumber = (String) SharedPreferencesUtil.getData(EditMyDeviceActivity.this, "areaNumber", "");
    ...
    public static HomeFragmentNew newInstance() {
        HomeFragmentNew newFragment = new HomeFragmentNew();
        Bundle bundle = new Bundle();
...
//        Collections.addAll(titles, "123", "456", "789");
        tablayout_vertical.setupWithViewPager(viewpager);
        tablayout_vertical.setTabSelected(position);
