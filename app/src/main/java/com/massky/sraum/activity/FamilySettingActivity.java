...
public class FamilySettingActivity extends BaseActivity implements XListView.
        IXListViewListener {
    ...
    private void sraum_getAllArea() {
        ...
        mapdevice.put("token", TokenUtil.getToken(FamilySettingActivity.this));
//        mapdevice.put("boxNumber", TokenUtil.getBoxnumber(SelectSensorActivity.this));
        MyOkHttp.postMapString(ApiHelper.sraum_getAllArea
                ...
                }, FamilySettingActivity.this, dialogUtil) {
                    @Override
...
//                            }
                            ...
                            add_room.setVisibility(View.GONE);
                            homesettingadapter = new MyAreaListAdapter(FamilySettingActivity.this, areaList, "familyManager");
                            xListView_scan.setAdapter(homesettingadapter);
                        }
                    }
                });
...
//        mapdevice.put("boxNumber", TokenUtil.getBoxnumber(SelectSensorActivity.this));
    ...
    private void display_room_list() {
        manageroomadapter = new ManagerRoomAdapter(FamilySettingActivity.this, roomList);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.add_room:
                startActivity(new Intent(FamilySettingActivity.this, AddAreaActivity.class));
                break;
        }
    }
