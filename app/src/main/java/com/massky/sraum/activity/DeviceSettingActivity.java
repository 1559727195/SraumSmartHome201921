...
public class DeviceSettingActivity extends BaseActivity implements XListView.IXListViewListener {
    ...
    private void sraum_getAllArea() {
        ...
        mapdevice.put("token", TokenUtil.getToken(DeviceSettingActivity.this));
//        mapdevice.put("boxNumber", TokenUtil.getBoxnumber(SelectSensorActivity.this));
        MyOkHttp.postMapString(ApiHelper.sraum_getAllArea
                ...
                }, DeviceSettingActivity.this, dialogUtil) {
                    @Override
...
//                            }
                            ...
                            add_room.setVisibility(View.GONE);
                            homesettingadapter = new MyAreaListAdapter(DeviceSettingActivity.this, areaList,"deviceManager");
                            xListView_scan.setAdapter(homesettingadapter);
                        }
                    }
                });
...
//        mapdevice.put("boxNumber", TokenUtil.getBoxnumber(SelectSensorActivity.this));
        MyOkHttp.postMapString(ApiHelper.sraum_getRoomsInfo
                , mapdevice, new Mycallback(new AddTogglenInterfacer() {
                    ...
                    @Override
                    public void wrongBoxnumber() {
                        ToastUtil.showToast(DeviceSettingActivity.this, "areaNumber\n" +
                                "不存在");
                    }
                    ...
                    public void threeCode() {
                        ToastUtil.showToast(DeviceSettingActivity.this, "areaNumber 不\n" +
                                "正确");
                    }
                });
    }
    ...
    private void display_room_list() {
        manageroomadapter = new ManagerRoomAdapter(DeviceSettingActivity.this, roomList);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.add_room:
                startActivity(new Intent(DeviceSettingActivity.this, AddAreaActivity.class));
                break;
        }
    }
