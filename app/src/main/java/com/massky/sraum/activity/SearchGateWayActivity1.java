...
//    ListView list_show_rev_item_detail;
    ...
    protected void onView() {
        ...
        showUdpServerAdapter = new ShowUdpServerAdapter(SearchGateWayActivity1.this
                , list);
    ...
    private void initDialog() {
        ...
        newFragment = SearchDialogFragment.newInstance(SearchGateWayActivity1.this, "", ""
...
//            SearchGateWayActivity.this.finish();
            Intent intent = new Intent(SearchGateWayActivity1.this, EditGateWayResultActivity.class);
...
//                }
            ...
            case R.id.search_result:
                SearchGateWayActivity1.this.finish();
                break;
...
//                        bundle.putString("result", code);
        ...
        SearchGateWayActivity1.this.setResult(RESULT_OK, intent);
        SearchGateWayActivity1.this.finish();
    }
